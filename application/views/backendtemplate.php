...
<head>
  ...
  <link href="<?= base_url('template/backend/vendor/datatables/dataTables.bootstrap4.min.css') ?>" rel="stylesheet">
...
<body id="page-top">
  ...
  <!-- Page level plugins -->
  <script src="<?= base_url('template/backend/vendor/datatables/jquery.dataTables.min.js') ?>"></script>
  <script src="<?= base_url('template/backend/vendor/datatables/dataTables.bootstrap4.min.js') ?>"></script>

  <!-- Page level custom scripts -->
  <script src="<?= base_url('template/backend/js/demo/datatables-demo.js') ?>"></script>
